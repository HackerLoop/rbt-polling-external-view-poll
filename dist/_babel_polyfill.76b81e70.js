...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../../.nvm/versions/node/v11.10.1/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{}],"_babel_polyfill.js":[function(require,module,exports) {
...
(function e(t, n, r) {
  ...
  7: [function (require, module, exports) {
    ...
    module.exports = {
      ...
      getEntry: getEntry,
      getIterConstructor: function getIterConstructor() {
  ...
  9: [function (require, module, exports) {
    ...
    module.exports = function (NAME, methods, common, IS_MAP, isWeak) {
      ...
      if (!$.isFunction(_C) || !(isWeak || !$iter.BUGGY && proto.forEach && proto.entries)) {
        _C = common.getConstructor(NAME, IS_MAP, ADDER);
        $.mix(_C.prototype, methods);
      } else {
        var inst = new _C(),
        ...
        if (!require("./$.iter-detect")(function (iter) {
          ...
          _C = function C(iterable) {
            assertInstance(this, _C, NAME);
            var that = new Base();
            if (iterable != undefined) $iter.forOf(iterable, IS_MAP, that[ADDER], that);
            return that;
          };
      ...
      require("./$.cof").set(_C, NAME);

      require("./$.species")(_C);

      O[NAME] = _C;
      $def($def.G + $def.W + $def.F * (_C != Base), O);
      if (!isWeak) $iter.std(_C, NAME, common.getIterConstructor(), common.next, IS_MAP ? "key+value" : "value", !IS_MAP, true);
      return _C;
    };
  }, {
    "./$": 16,
  ...
  15: [function (require, module, exports) {
    ...
    function getIterator(it) {
      var _Symbol = $.g.Symbol,
          ext = it[_Symbol && _Symbol.iterator || FF_ITERATOR],
    ...
    var $iter = module.exports = {
      ...
      is: function is(it) {
        var O = Object(it),
            _Symbol2 = $.g.Symbol,
            SYM = _Symbol2 && _Symbol2.iterator || FF_ITERATOR;
      ...
      std: function std(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCE) {
      ...
      forOf: function forOf(iterable, entries, fn, that) {
  ...
  16: [function (require, module, exports) {
    ...
    function isObject(it) {
      return it !== null && (_typeof(it) == "object" || typeof it == "function");
    }
  ...
  59: [function (require, module, exports) {
    ...
    function wrap(tag) {
      var sym = AllSymbols[tag] = $.set($.create(_Symbol3.prototype), TAG, tag);
    ...
    if (!$.isFunction(_Symbol3)) {
      _Symbol3 = function _Symbol4(description) {
        if (this instanceof _Symbol4) throw TypeError("Symbol is not a constructor");
        return wrap(uid(description));
      };

      hide(_Symbol3.prototype, "toString", function () {
        return this[TAG];
      });
    }
    ...
    var symbolStatics = {
      "for": function _for(key) {
        return has(SymbolRegistry, key += "") ? SymbolRegistry[key] : SymbolRegistry[key] = _Symbol3(key);
      },
    ...
    $.each.call(("hasInstance,isConcatSpreadable,iterator,match,replace,search," + "species,split,toPrimitive,toStringTag,unscopables").split(","), function (it) {
      ...
      symbolStatics[it] = _Symbol3 === Base ? sym : wrap(sym);
    });
    setter = true;
    $def($def.S, "Symbol", symbolStatics);
    $def($def.S + $def.F * (_Symbol3 != Base), "Object", {
...
},{"process":"../../.nvm/versions/node/v11.10.1/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../../.nvm/versions/node/v11.10.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../.nvm/versions/node/v11.10.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","_babel_polyfill.js"], null)
//# sourceMappingURL=/_babel_polyfill.76b81e70.js.map